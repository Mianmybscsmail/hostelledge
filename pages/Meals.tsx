...
import { Coffee, Sun, Moon, ChefHat, Pencil, Trash2, CalendarDays, ChevronRight } from 'lucide-react';
      ...
      <div className="space-y-3">
        ...
        <div key={meal.id} className="bg-white dark:bg-zinc-900 p-4 rounded-xl border border-gray-200 dark:border-zinc-800 flex items-start gap-3 relative group shadow-sm">
            ...
            <div className="flex justify-between items-start">
                <h3 className="font-medium text-gray-900 dark:text-white">{meal.meal_type}</h3>
